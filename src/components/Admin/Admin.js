...
const Admin = () => {
  ...
  const userListData = [
    { id: 1, user: "john@sysco.com", use_case: ["Redx"], modules_screens: ["redx_sales_report"] },
    { id: 2, user: "bill@sysco.com", use_case: ["Admin"], modules_screens: ["redx_sales_report", "redx_daily_issue_report"] },
  ];
